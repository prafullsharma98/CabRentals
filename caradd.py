...
carid = form.getvalue('carid')
brand = form.getvalue('brand')
model = form.getvalue('model')
seater = form.getvalue('seater')
ppd = form.getvalue('ppd')
...
conn.execute("INSERT INTO CAR  \
      VALUES (?,?,?,?,?,?)",(carid,brand,model,seater,ppd,url));
...
print("<script> alert('car with id:"+carid+" added ')  </script>")
